	...
	<body bgcolor="#A0CAF9">	
		<table align="center">
			...
			<tr align="center">
				<td align="center">
					<br />
					<form name="fcForm" method="post" action="resetjudge.php">
					<table align="center" border="0">
						...
						<tr align="center">
							<td align="center">
								...
								<br />
						<?php
								echo "<h3>Warning: Resetting results will reset all contestants for this event. This can not be undone!</h3>";								
								
								if(isset($_POST['catOrder'])) {
								  $selected=$_POST['catOrder'];
								  mysql_query("UPDATE events SET results='0' WHERE category_id = '$selected'");
								}

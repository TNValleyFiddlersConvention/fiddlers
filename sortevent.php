					...
					<table align="center" border="0">
							...
							<td align="center">
								...
								<?php
									...
									if ( isset($_POST['ddlCatList']) )
									{
										...
										$query = "SELECT events.contestant_id, contestants.contestant_no, contestants.fname, contestants.mi, contestants.lname, contestants.age FROM events INNER JOIN contestants ON contestants.contestant_id=events.contestant_id WHERE events.category_id = '" . $_POST['ddlCatList'] . "' ORDER BY contestants.contestant_no";
						...
						<tr align="center">
								<td align="center">
									<br />
									<!-- GO TO regsubmit.php -->
									<input type="submit" value="Print Results" />
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- GO TO HOME PAGE -->
